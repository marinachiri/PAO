...
public class BankingApp {
    ...
    public static void main(String[] args) {
        ...
        Customer c1 = new Customer(1, "Alexandru", "Macedonschi", "1750101410165", "2023-02-20", "alex.mace@yahoo.com", "+40 734 650 538", "Strada Mica, Craiova");
        Customer c2 = new Customer(2, "Diana", "Turcu", "2750101410164", "2023-02-20", "diana.turcu@yahoo.com", "0701 216 393", "strada Mare, Bucuresti");
        Customer c3 = new Customer(3, "Iulian", "Ionescu", "1740101410165", "2000-03-30", "iulian.ionescu@yahoo.com", "+40 702 044 125", "Sat Bucur, judetul Botosani");
        Customer c4 = new Customer(4, "Mihaela", "Dragut", "2750101410166", "1999-09-09", "mihaela.draguyt@gmail.com", "0791 291 881", "Strada principala nr1, Tecuci");
